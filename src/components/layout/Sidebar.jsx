...
import { Box, Layers, Folder, Plus } from 'lucide-react';
        ...
        <>
            <aside className={`w-64 bg-white border-r border-gray-200 flex flex-col z-50 transition-transform duration-300 fixed md:relative h-full ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
                ...
                <div className="p-3 border-t border-gray-100">
                    <button onClick={() => { setEditingCat(null); setModals(prev => ({...prev, category: true})); }} className="w-full flex items-center justify-center gap-2 py-2 px-3 text-gray-500 hover:text-black hover:bg-gray-50 rounded-md transition-colors border border-dashed border-gray-300 hover:border-gray-400">
